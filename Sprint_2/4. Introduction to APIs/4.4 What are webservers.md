### Overview
This chapter introduces to the web servers. So far whatever applications we have created have been only accessible why command line. It is will very practial if the user can open a url in a browser and interact with our application. This is where web servers come into picture.
